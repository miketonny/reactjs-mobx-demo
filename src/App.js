...
class App extends Component {
  ...
  componentWillMount(){
    //setup default rows/columns.. fetch from localstorage ======
    ...
    splits.push({'value':'Split 1', 'label': 'Split 2'});
  ...
  refresh(){ 
    let model = new DataModel(this.state.dataColumns, this.state.dataRows);
  ...
  render() {     
    return (
      <div className="App row" onClick={this.handleOverlay.bind(this)}>
        ...
        <div className="col-md-3"><GroupBox groups={this.state.PositionalGroups} positions={this.state.Positions} statusGrps={this.state.StatusGroups}
